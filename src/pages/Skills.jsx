...
function Skills() {
  return (
    <div className="w-full flex flex-col justify-center items-start p-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-7 xl:grid-cols-8 gap-4 mt-8">
        {skills.map((skill, index) => (
          <div key={index} className="relative w-32 h-32 flex flex-col justify-center items-center bg-[#111111] rounded-lg shadow-lg">
