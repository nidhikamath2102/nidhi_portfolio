...
function About() {
  return (
    <div className="w-full flex flex-col justify-center items-center p-6">
      ...
      <p className="color-paragraph mt-4 custom-line-height text-base">
      ...
      <div className="flex flex-wrap justify-center mt-4 ">
        {boxItems.map((item, index) => (
          <div key={index} className="w-full md:w-1/2 p-3 flex justify-center">
            <div
              className="w-full md:w-full h-full flex items-center justify-center rounded-[15px] text-white text-center p-6 text-base custom-3d-block"
